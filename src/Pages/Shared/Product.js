        ...
        <div className="w-300 md:w-[298px] xl:w-375 cursor-pointer h-auto bg-gray-100 rounded-lg py-2 my-4 md:my-9 backdrop-blur-lg shadow-lg hover:drop-shadow-2xl hover:-translate-y-1 duration-500 mx-2">
            <div className='w-full flex items-center justify-between'>
                <motion.img
                    ...
                    className='w-40 -mt-8'
                />
                <Link to={`/stock-update/${product._id}`}><motion.button whileTap={{ scale: 0.75 }} className='w-24 h-12 rounded-full bg-orange-400 flex items-center justify-center cursor-pointer hover:shadow-md mr-3'>
