...
const Footer = () => {
    ...
    return (
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
            ...
            md:justify-start
          ">
                            <img src={Logo} className='w-5 mr-3 object-cover' alt="Logo" />
                            Food Corner
                        </h6>
                        <p>
                    ...
                    <div className="">
                        ...
                        <p className="mb-4 text-gray-600">Pricing</p>
                        <p className="mb-4 text-gray-600">Settings</p>
                        <p className="mb-4 text-gray-600">Orders</p>
                        <p className="mb-4 text-gray-600">Help</p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                            Contact
            ...
            <div className="text-center p-6 bg-gray-200">
                ...
                <span className="text-gray-600 font-semibold"> Food Corner</span>
            </div>
        </footer>
    );
};
