...
const StockUpdate = () => {
    ...
    return (
        <>
            ...
            <Link to='/allitem' className='w-full flex justify-center '>
                <span className="p-3 text-center font-bold text-gray-500 hover:text-white border-2 border-orange-500 rounded-md text-base hover:bg-orange-500 hover:border-orange-400 cursor-pointer">
                    Manage Items
                </span>
            </Link>
        </>
